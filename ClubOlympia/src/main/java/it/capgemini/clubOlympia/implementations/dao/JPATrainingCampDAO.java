...
@Repository
public class JPATrainingCampDAO extends JPACrudDAO<TrainingCamp> implements TrainingCampDAO {
...
//	}
	...
	public void changeEnrollment(int trainingCampId, Client client, boolean enroll) {
		TrainingCamp camp = this.findById(trainingCampId, TrainingCamp.class);
		if(enroll) {
			camp.enroll(client);
		} else {
